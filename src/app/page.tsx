...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen">
      ...
      {/* 1. HERO BANNER */}
      <section className="relative overflow-hidden bg-slate-50 py-20 lg:py-28 flex items-center border-b border-slate-100">
        {/* Abstract shapes/circles for premium branding feel */}
        <div className="absolute top-0 right-0 w-[40%] h-[60%] bg-blue-105/20 rounded-full blur-[120px] pointer-events-none -z-10" />
        <div className="absolute bottom-0 left-[10%] w-[30%] h-[40%] bg-sky-100/30 rounded-full blur-[100px] pointer-events-none -z-10" />
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          
          {/* Hero Left Content */}
          <div className="lg:col-span-7 flex flex-col gap-6 text-center lg:text-left">
            <div className="inline-flex items-center gap-1.5 self-center lg:self-start bg-blue-50 border border-blue-100/80 rounded-full px-4 py-1.5 shadow-sm">
            ...
            <h1 className="font-display font-black text-slate-905 text-4xl sm:text-5xl xl:text-6xl tracking-tight leading-[1.1]">
              Crack <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-blue-600 to-secondary">IIT-JEE & NEET</span> With Expert Guidance
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mt-2">
              <Link
                ...
                className="w-full sm:w-auto bg-primary hover:bg-primary-dark text-white text-base font-bold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200 text-center"
              >
                Enroll Now
              </Link>
              <Link
                href="/contact?enquire=counsel"
                className="w-full sm:w-auto bg-white hover:bg-slate-50 text-slate-800 text-base font-bold px-8 py-4 rounded-xl shadow-md hover:shadow-lg border border-slate-200 transition-all duration-200 text-center flex items-center justify-center gap-2"
              >
                <Calendar className="h-5 w-5 text-primary" /> Book Free Counselling
              </Link>
            </div>
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center mt-6 lg:mt-0">
            <div className="relative w-full max-w-[400px] h-[400px] flex items-center justify-center">
              {/* Graphic backgrounds */}
              <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-secondary/15 rounded-3xl rotate-6 -z-10 shadow-md" />
              <div className="absolute inset-0 bg-white rounded-3xl shadow-2xl p-6 flex flex-col justify-between border border-slate-100">
                ...
                <div className="flex-grow flex flex-col justify-center gap-6 py-6">
                  ...
                  <div className="flex items-center gap-3.5 bg-blue-50/50 p-3.5 rounded-xl border border-blue-100/50">
                    <div className="p-2 rounded-lg bg-primary text-white">
                      <BookOpen className="h-5 w-5" />
                    </div>
                    <div className="flex-grow text-left">
                      <span className="text-xs font-bold text-slate-405 block">Module Status</span>
                      <span className="text-sm font-extrabold text-slate-900">Concept Building Sheets</span>
                    </div>
                    <span className="text-xs font-black text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-md">100%</span>
                  </div>
                  ...
                  <div className="flex items-center gap-3.5 bg-yellow-50/50 p-3.5 rounded-xl border border-yellow-100/50">
                    ...
                    <div className="flex-grow text-left">
                      ...
                      <span className="text-sm font-extrabold text-slate-900">IIT-JEE & NEET Focus</span>
                    </div>
                  ...
                  <div className="flex items-center gap-3.5 bg-sky-50/50 p-3.5 rounded-xl border border-sky-100/50">
                    ...
                    <div className="flex-grow text-left">
                      ...
                      <span className="text-sm font-extrabold text-slate-900">1-on-1 Personalized Session</span>
                    </div>
                    <span className="text-xs font-black text-secondary bg-sky-50 px-2 py-0.5 rounded-md">Live</span>
                  </div>
                ...
                <div className="pt-4 border-t border-slate-100 flex items-center justify-between text-left">
                  <div>
                    ...
                    <span className="text-sm font-extrabold text-slate-800">99.85 Percentile</span>
                  </div>
              ...
              <div className="absolute -bottom-4 -left-6 bg-slate-900 text-white rounded-xl shadow-xl p-4 flex items-center gap-3 border border-slate-800">
                <div className="h-10 w-10 rounded-lg bg-gradient-to-tr from-accent to-yellow-300 text-slate-900 flex items-center justify-center font-black text-lg">
                  #1
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyChooseUsData.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-slate-50 hover:bg-white p-6 rounded-2xl border border-slate-100 hover:border-blue-100 hover:shadow-lg hover:-translate-y-1.5 transition-all duration-300 text-left flex flex-col gap-4 group cursor-default"
                >
                  <div className="p-3.5 rounded-xl bg-blue-50 text-primary self-start group-hover:bg-primary group-hover:text-white transition-colors duration-300">
                    <IconComponent className="h-6 w-6" />
                  </div>
                  <div>
                    <h3 className="font-display font-bold text-slate-905 text-lg mb-1 group-hover:text-primary transition-colors">
                      {item.title}
                    </h3>
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-3">
            <span className="text-xs font-black text-primary uppercase tracking-widest">Our Programs</span>
            <h2 className="font-display font-extrabold text-slate-900 text-3xl sm:text-4xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-3xl border border-slate-100 shadow-lg overflow-hidden flex flex-col justify-between hover:shadow-xl transition-shadow duration-300">
              <div className="p-8">
                <div className="bg-blue-50 text-primary text-xs font-extrabold uppercase px-3 py-1.5 rounded-lg inline-block mb-4">
                  Engineering Track
                </div>
              ...
              <div className="p-8 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                <Link
                  ...
                  className="text-primary font-bold text-sm flex items-center gap-1 hover:text-primary-dark transition-colors"
                >
                  View Details <ArrowRight className="h-4 w-4" />
                </Link>
                <Link
                  href="/contact?enquire=enroll&course=jee"
                  className="bg-primary hover:bg-primary-dark text-white text-xs font-bold py-2 px-4 rounded-lg transition-colors"
                >
                  Enroll
                </Link>
              </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-100 shadow-lg overflow-hidden flex flex-col justify-between hover:shadow-xl transition-shadow duration-300">
              <div className="p-8">
                <div className="bg-sky-50 text-secondary text-xs font-extrabold uppercase px-3 py-1.5 rounded-lg inline-block mb-4">
                  Medical Track
                </div>
                <h3 className="font-display font-extrabold text-slate-900 text-2xl mb-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
            <div className="text-left flex flex-col gap-2">
              <span className="text-xs font-black text-primary uppercase tracking-widest">Our Co-Founders</span>
            ...
            <Link
              href="/faculty"
              className="text-primary font-bold text-sm flex items-center gap-1 hover:text-primary-dark transition-colors self-start md:self-auto"
            >
            ...
            {FACULTY_DATA.map((member, index) => (
              ...
              >
                ...
                <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl bg-gradient-to-br from-primary-dark to-primary flex flex-col items-center justify-center text-white font-display font-black text-3xl flex-shrink-0 shadow-inner relative overflow-hidden">
                  {member.avatarSeed === "chandan" ? (
                    ...
                    <>
                      ...
                      <span className="text-[9px] uppercase tracking-widest text-blue-200 mt-1 font-sans font-semibold">Ex-Allen</span>
                    </>
                  )}
                </div>
                ...
                <div className="flex-grow text-left">
                  ...
                  <p className="text-xs font-extrabold text-primary uppercase tracking-wider mb-3">
                    {member.role}
                  </p>
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col gap-3">
            <span className="text-xs font-black text-primary uppercase tracking-widest">Easy Steps</span>
            <h2 className="font-display font-extrabold text-slate-905 text-3xl sm:text-4xl">
              Admission Process
            </h2>
            <div className="h-1 w-20 bg-accent rounded mx-auto mt-2" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
            {ADMISSION_STEPS.map((step, idx) => (
              <div key={idx} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-150 relative text-left">
                <div className="h-10 w-10 rounded-xl bg-primary text-white flex items-center justify-center font-display font-black text-base mb-4 shadow-md">
                  {idx + 1}
                </div>
